...
export const DEFAULT_WORKFLOWS: WorkflowDefinition[] = [
  {
    ...
    stages: [
      { id: "analyst", agent: "analyst", description: "分析需求边界、影响范围、方案和风险", outputSchema: "analysis", review: { agent: "oracle" } },
  ...
  },
  {
    ...
    stages: [
      { id: "analyst", agent: "analyst", description: "分析修复范围、边界和风险", outputSchema: "analysis", review: { agent: "oracle" } },
  ...
  },
  {
    ...
    description: "研究流程：分析",
    stages: [
      { id: "analyst", agent: "analyst", description: "分析研究问题并做只读研究结论", outputSchema: "analysis", review: { agent: "oracle" } },
    ],
  },
];
